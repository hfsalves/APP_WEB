...
class DocInbox(db.Model):
    ...
    invoice_type       = db.Column(db.String(20), nullable=False, default='unknown')
    reception_validated = db.Column(db.Boolean, nullable=False, default=False)
    reception_validated_at = db.Column(db.DateTime, nullable=True)
    reception_validated_by = db.Column(db.String(50), nullable=False, default='')
    management_validated = db.Column(db.Boolean, nullable=False, default=False)
    management_validated_at = db.Column(db.DateTime, nullable=True)
    management_validated_by = db.Column(db.String(50), nullable=False, default='')
    accounting_validated = db.Column(db.Boolean, nullable=False, default=False)
    accounting_validated_at = db.Column(db.DateTime, nullable=True)
    accounting_validated_by = db.Column(db.String(50), nullable=False, default='')

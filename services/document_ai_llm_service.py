        ...
        'properties': {
            ...
            'lines': {
                ...
                'items': {
                    ...
                    'required': ['ref', 'description', 'qty', 'unit', 'unit_price', 'discount', 'tax_rate', 'net_amount', 'gross_amount'],
                },
            },
...
def classify_document_visual(context: dict[str, Any]) -> dict[str, Any]:
    ...
    base_prompt = {
        ...
        'rules': [
            ...
            'Extract visible item/material/service lines into lines[]. At minimum, capture description, qty and unit when present.',
